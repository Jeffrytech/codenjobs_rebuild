...
import { BUY_CODE, CODE_SOLANA_TOKEN, COMPANY_NAME } from "../../config/environment";
...
const moreFAQs = [
  ...
  },
  {
    ...
    <ExternalLink href={"https://www.codenjobs.com/blog/post"} >
      <span className={styles.faqlink}>
        You can post a blog after you make an account and login at our website.
      </span>
    </ExternalLink> 
  },
  {
...
const blogList = [
  {
    ...
    cover: "https://res.cloudinary.com/codenjobs/image/upload/v1650475589/user/blog/cover/zsregoy0vp3scpjcey2r.jpg",
    ...
    <div className={styles.App}>
      <div className={styles.top}>
        ...
        <p className={`paragraph`}>
          ...
          We are here to help you find remote blockchain jobs and candidates from anywhere in the world.
        </p>
      ...
      <div className={`${styles.message} message`}>
        ...
        <p
          ...
          className={`paragraph`}
        >
          {/* <span>Our <img style={{ width: "1.25rem", height: "1.25rem" }} src="/static/logo.png" /> CODE token</span> is deployed on <img style={{ width: "1.25rem", height: "1.25rem"}} src="/static/logos/solana.png" /> Solana blockchain for its speed and */}
          {/* Our <img style={{ width: "1.5rem", height: "1.5rem" }} src="/static/logo.png" /> <span style={{ color: black }}> CODE</span> token  is deployed on <img style={{ width: "1.25rem", height: "1.25rem" }} src="/static/logos/solana.png" /> Solana blockchain for its speed and */}
          {/* <ExternalLink href={BUY_CODE} ><img style={{ width: "1.25rem", height: "1.25rem" }} src="/static/logo.png" /><span style={{ color: black }}> CODE</span></ExternalLink>  token  is deployed on <img style={{ width: "1.25rem", height: "1.25rem" }} src="/static/logos/solana.png" /> <span style={{ color: solana }}>Solana</span> blockchain for its speed and */}
          <ExternalLink href={BUY_CODE} >
            <span className={styles.code} >
              {/* <img style={{ width: "1rem", height: "1rem" }} src="/static/logo.png" /> */}
              {/* <span style={{ color: black }}> CODE</span> */}
              <span style={{ color: black }}> CODE</span>
            </span>
          </ExternalLink> is deployed on <img style={{ width: "1rem", height: "1rem" }} src="/static/logos/solana.png" /> <span>Solana</span> blockchain for its speed and
          robustness while remaining decentralized and with low transaction
          fees, compared to the other blockchains.
        </p>
      </div>
