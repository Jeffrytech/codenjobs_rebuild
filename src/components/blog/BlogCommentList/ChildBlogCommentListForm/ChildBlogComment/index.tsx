...
function ChildBlogComment({
  ...
  const [totalMoneyVoteForBlogComment, setTotalMoneyVoteForBlogComment] =
    useState(blog_comment_money_voters.length);

  const [showChildBlogCommentEdit, setShowChildBlogCommentEdit] =
    useState(false);
  ...
  return (
    <ChildBlogCommentContainer>
      <ChildBlogCommentListBody>
        <ChildBlogCommentListWrapper>
          <ChildBlogCommentListUserProfile>
            <Avatar name={commenter} size="2.5rem" src={profile_image || ""} />
