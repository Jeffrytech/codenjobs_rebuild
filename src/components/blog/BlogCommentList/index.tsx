  ...
  const handleCommentable = async () => {
    if (commentable === true) {
      const response = confirm(
        "This will remove all comments if there were any also, are you sure?"
      );
      if (response === true) {
    ...
    >
      ...
      {commentable && (
        <BlogCommentListBody>
          ...
          {/* Extract this? */}
          {totalBlogComments !== 0 && commentId === null && (
            <div
              style={{
                marginTop: "1rem",
                marginBottom: "1rem",
            ...
            >
              <div>
                <Select
                  ...
                  value={findBlogCommentSortOptionsLabelValue(
                    sortBlogCommentList
                  )}
          ...
          {commentId !== null && (
            <ReadBlogCommentList>
              <Link
                href={`/blog?&title=${router.query["title"]}&id=${router.query["id"]}&showComment=true`}
              >
                <span>Show all comment list</span>
              </Link>
            </ReadBlogCommentList>
          )}
      ...
      {!commentable && user.username === writer && (
        <BlogCommentListBody>
          <div
            style={{
              opacity: "0.7",
