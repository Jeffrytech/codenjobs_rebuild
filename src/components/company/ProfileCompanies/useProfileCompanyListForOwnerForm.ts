...
import { findProfileCompanyListOwnerSortOptionsLabelValue } from "../../../typeDefinitions/company";
import { useRouter } from "next/router";
import { scrollToTop } from "../../../browser/scroll";

// import { Title } from "@material-ui/icons";

const useProfileCompanyListForOwnerForm = ({
  page,
  sort,
}) => {
  ...
  const {
    ...
    initialValues: {
      sort: findProfileCompanyListOwnerSortOptionsLabelValue(sort),
      // page,
    },
...
export default useProfileCompanyListForOwnerForm;