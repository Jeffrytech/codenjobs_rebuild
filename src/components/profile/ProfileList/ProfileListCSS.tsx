...
const ProfileUserFileListContainer = styled("div", {
  width: "64rem",
  minHeight: 0,
...
// const SolanaNFTWalletListContainer = styled("ul", ({ $includeMoreList }) => {
//   // alert($includeMoreList);

//   let desktopFlexBasis = "0";
//   if ($includeMoreList === 1) {
//     desktopFlexBasis = "36.25rem";
//   } else if ($includeMoreList === 2) {
//     desktopFlexBasis = "18.125rem";
//   }
...
const ProfileUserFileListSection = styled("section", ({ $includeMoreList }) => {

  let desktopFlexBasis = "0";
  if ($includeMoreList === 1) {
    // desktopFlexBasis = "42.25rem";
    desktopFlexBasis = "36.25rem";
  } else if ($includeMoreList === 2) {
    desktopFlexBasis = "18.125rem";
    // desktopFlexBasis = "21.125rem";
  }
