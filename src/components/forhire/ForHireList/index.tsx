...
import {
  ForHireListSkillContainer,
  ForHireListSkill,
} from "./ForHireListSkills/ForHireListSkillsCSS";
...
const ForHireList = ({
  ...
  }, [page, job, salary, location, skill, use_cryptocurrency, sort]);
        ...
        <ForHireSearchListContainer>
          <ForHireSearchListContent>
            <ForHireSearchListPrimaryWrapper>
              <ForHireNoSearchListHeader>
                <CentralizeChildren>
                  <NoSearchList href="/forhire" message="No results" />
                </CentralizeChildren>
              </ForHireNoSearchListHeader>
              <ForHireSearchListSkeleton />
              <ForHireSearchListSkeleton />
              ...
              ({
                ...
                return (
                  ...
                  >
                    ...
                    {profile_bio && <ProfileBio>{profile_bio}</ProfileBio>}
                    ...
                    {total_blog_post_money_voters !== undefined && (
                      <TotalMoneyVoteContainer>
                        <TotalMoneyVoteWrapper>
                    ...
                    <ForHireListSkillContainer>
                      {profile_skills &&
                        profile_skills.map((profile_skill: string) => {
