...
import { 
  MintLayout, TOKEN_PROGRAM_ID, 
  
  // Should call these correctly
...
export const awaitTransactionSignatureConfirmation = async (
  ...
  // alert(txid); // It shouldn't be undefined
...
// TODO
// Use this with program_id and show UI
...
export const mintOneToken = async (
  ...
  // alert("before try at the end");

  try {
    // alert("tx fails here");
    // alert(metadataAddress);

    // Error
    // WalletNotConnectedError

    // alert(candyMachine.program.provider.connection);
    // alert(candyMachine.program.provider.wallet);

    // console.log(
    //   `candyMachine.program.provider.connection,
    //   wallet, // This part is not correct?
    //   instructionsMatrix,
    //   signersMatrix,
    //   SequenceType.StopOnFailure,
    //   "singleGossip",
    ...
    const txns = (
      await sendTransactions(
        candyMachine.program.provider.connection,
        // candyMachine.program.provider.wallet, // This part is not correct?
        wallet, // This part is not correct?
        instructionsMatrix,
        signersMatrix,
        SequenceType.StopOnFailure,
