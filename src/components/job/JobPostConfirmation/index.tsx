  ...
  return (
    <>
      ...
      <JobPostConfirmationContainer>
        ...
        >
          Thank you {user.username}, the payment with <span style={{
            color: payment_method === "solana" ? solana : black,
          }} >
            {payment_method === "solana" ? <SolanaImage /> : <img src="/static/logo.png" style={{
              width: "1.25rem",
              height: "1.25rem",
        ...
        <Typography sx={{ 
          ...
          An email with the details of <ExternalLink href={`${SOLSCAN}/tx/${pay_job_post_tx}`} >
            <span style={{
              color: solana,
            }} >
              this transaction
            </span>
          </ExternalLink> will be sent to you shortly.
        </Typography>
