...
export const JobPostFormWithNoSSR = dynamic(() => import("../../../components/job/JobPostForm"), {
  ssr: false
});
...
const Index = ({
  ...
  return (
    <>
      <Head>
        <title>{id ? "Edit the job post" : "Create a new job post"}</title>
      </Head>

      {/* <Layout useScrollToTop={false} > */}
      <Layout showFooter={false} >
        <JobPostFormWithNoSSR id={id} user={user} />
      </Layout>
    </>
  );
};
